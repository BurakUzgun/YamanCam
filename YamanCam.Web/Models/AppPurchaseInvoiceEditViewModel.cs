...
public class AppPurchaseInvoiceEditViewModel
{
    ...
    public List<AppPurchaseInvoiceLineEditViewModel> Lines { get; set; } = new()
    {
        new AppPurchaseInvoiceLineEditViewModel(),
        new AppPurchaseInvoiceLineEditViewModel()
    };
...
public class AppPurchaseInvoiceLineEditViewModel
{
    public int RecId { get; set; }
