...
public class AppStockIssueEditViewModel
{
    ...
    public List<AppStockIssueLineEditViewModel> Lines { get; set; } = new()
    {
        new AppStockIssueLineEditViewModel(),
        new AppStockIssueLineEditViewModel()
    };
...
public class AppStockIssueLineEditViewModel
{
    public int RecId { get; set; }
