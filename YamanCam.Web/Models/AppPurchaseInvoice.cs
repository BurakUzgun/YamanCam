...
public class AppPurchaseInvoice
{
    ...
    /// <summary>
    /// true ise bu kayıt Alış İade Faturası'dır (AppPurchaseReturnInvoicesController),
    /// aksi halde normal Alış Faturası'dır (AppPurchaseInvoicesController). Aynı
    /// tablo/alanları paylaşırlar, yalnızca bu bayrakla ayrılırlar.
    /// </summary>
    ...
    public List<AppPurchaseInvoiceLine> Lines { get; set; } = new();
}
